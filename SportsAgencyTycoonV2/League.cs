...
namespace SportsAgencyTycoonV2
{
    public class League
    {
        ...
        {
            if (sport == Sports.Basketball) return new Date(4, 1);
            else if (sport == Sports.Football) return new Date(1, 3);
            else if (sport == Sports.Hockey) return new Date(5, 4);
            else if (sport == Sports.Soccer) return new Date(12, 1);
            else return new Date(5, 1);
        }
    }
}

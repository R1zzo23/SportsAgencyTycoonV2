...
namespace SportsAgencyTycoonV2
{
    public class Football
    {
        ...
        public void SimWeek()
        {
            ...
            if (World.calendar.Month == 12 && World.calendar.Week == 1)
            {
        ...
        public string DisplayMVPTop5()
        {
            ...
            mvpRanks[0].Awards.Add(new Award(World.calendar.Year, "NFL MVP"));
        ...
        public string DisplayOPOYTop5()
        {
            ...
            //give the winner the award
            OPOYCandidates[0].Awards.Add(new Award(World.calendar.Year, "NFL Offensive Player of the Year"));
        ...
        public string DisplayDPOYTop5()
        {
            ...
            //give the winner the award
            DPOYCandidates[0].Awards.Add(new Award(World.calendar.Year, "NFL Defensive Player of the Year"));

            return results;
        }
        public void SimulateSuperBowl()
        {
            AFCPlayoffs[0].Awards.Add(new Award(World.calendar.Year - 1, "AFC Champions"));
            NFCPlayoffs[0].Awards.Add(new Award(World.calendar.Year - 1, "NFC Champions"));
        ...
        public string DeterminePlayoffField()
        {
            ...
            AFC[afcEastIndex].Awards.Add(new Award(World.calendar.Year, AFC[afcEastIndex].Conference + " " + AFC[afcEastIndex].Division + " Division Champs"));
            AFC.RemoveAt(afcEastIndex);

            int afcSouthIndex = AFC.FindIndex(t => t.Division == "South");
            AFCPlayoffs.Add(AFC[afcSouthIndex]);
            AFC[afcSouthIndex].Awards.Add(new Award(World.calendar.Year, AFC[afcSouthIndex].Conference + " " + AFC[afcSouthIndex].Division + " Division Champs"));
            AFC.RemoveAt(afcSouthIndex);

            int afcNorthIndex = AFC.FindIndex(t => t.Division == "North");
            AFCPlayoffs.Add(AFC[afcNorthIndex]);
            AFC[afcNorthIndex].Awards.Add(new Award(World.calendar.Year, AFC[afcNorthIndex].Conference + " " + AFC[afcNorthIndex].Division + " Division Champs"));
            AFC.RemoveAt(afcNorthIndex);

            int afcWestIndex = AFC.FindIndex(t => t.Division == "West");
            AFCPlayoffs.Add(AFC[afcWestIndex]);
            AFC[afcWestIndex].Awards.Add(new Award(World.calendar.Year, AFC[afcWestIndex].Conference + " " + AFC[afcWestIndex].Division + " Division Champs"));
            ...
            NFC[nfcEastIndex].Awards.Add(new Award(World.calendar.Year, NFC[nfcEastIndex].Conference + " " + NFC[nfcEastIndex].Division + " Division Champs"));
            NFC.RemoveAt(nfcEastIndex);

            int nfcSouthIndex = NFC.FindIndex(t => t.Division == "South");
            NFCPlayoffs.Add(NFC[nfcSouthIndex]);
            NFC[nfcSouthIndex].Awards.Add(new Award(World.calendar.Year, NFC[nfcSouthIndex].Conference + " " + NFC[nfcSouthIndex].Division + " Division Champs"));
            NFC.RemoveAt(nfcSouthIndex);

            int nfcNorthIndex = NFC.FindIndex(t => t.Division == "North");
            NFCPlayoffs.Add(NFC[nfcNorthIndex]);
            NFC[nfcNorthIndex].Awards.Add(new Award(World.calendar.Year, NFC[nfcNorthIndex].Conference + " " + NFC[nfcNorthIndex].Division + " Division Champs"));
            NFC.RemoveAt(nfcNorthIndex);

            int nfcWestIndex = NFC.FindIndex(t => t.Division == "West");
            NFCPlayoffs.Add(NFC[nfcWestIndex]);
            NFC[nfcWestIndex].Awards.Add(new Award(World.calendar.Year, NFC[nfcWestIndex].Conference + " " + NFC[nfcWestIndex].Division + " Division Champs"));

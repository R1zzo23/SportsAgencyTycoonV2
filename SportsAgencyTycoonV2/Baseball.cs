...
namespace SportsAgencyTycoonV2
{
    public class Baseball
    {
        ...
        public void SimWeek()
        {
            ...
            if (World.calendar.Month == 9 && World.calendar.Week == 1)
            {
            ...
            if (MLB.Playoffs)
            {
                if (MLB.WeekNumber == 26) SimulateWildCardRound(); //mainForm.newsLabel.Text = SimulateWildCardRound() + Environment.NewLine + mainForm.newsLabel.Text;
                if (MLB.WeekNumber == 27 || MLB.WeekNumber == 28) SimulateRoundsTwoAndThree();  //mainForm.newsLabel.Text = SimulateRoundsTwoAndThree() + Environment.NewLine + mainForm.newsLabel.Text;
                if (MLB.WeekNumber == 29) SimulateWorldSeries();  //mainForm.newsLabel.Text = SimulateWorldSeries() + Environment.NewLine + mainForm.newsLabel.Text;
            }
        }
        #region Statistics
        ...
        private string DeterminePlayoffField()
        {
            ...
            AmericanLeague[alEastIndex].Awards.Add(new Award(World.calendar.Year, AmericanLeague[alEastIndex].Division + " Division Champs"));
            ...
            AmericanLeague[alCentralIndex].Awards.Add(new Award(World.calendar.Year, AmericanLeague[alCentralIndex].Division + " Division Champs"));
            ...
            AmericanLeague[alWestIndex].Awards.Add(new Award(World.calendar.Year, AmericanLeague[alWestIndex].Division + " Division Champs"));
            ...
            NationalLeague[nlEastIndex].Awards.Add(new Award(World.calendar.Year, NationalLeague[nlEastIndex].Division + " Division Champs"));
            ...
            NationalLeague[nlCentralIndex].Awards.Add(new Award(World.calendar.Year, NationalLeague[nlCentralIndex].Division + " Division Champs"));
            ...
            NationalLeague[nlWestIndex].Awards.Add(new Award(World.calendar.Year, NationalLeague[nlWestIndex].Division + " Division Champs"));
        ...
        private string SimulateWorldSeries()
        {
            ...
            ALPlayoffs[0].Awards.Add(new Award(World.calendar.Year, "American League Champs"));
            NLPlayoffs[0].Awards.Add(new Award(World.calendar.Year, "National League Champs"));

            results = SimulateSeries(ALPlayoffs[0], NLPlayoffs[0], 0, 1);
            if (losingIndex == 0)
            {
                results = "The " + NLPlayoffs[0].City + " " + NLPlayoffs[0].Mascot + " are the " + World.calendar.Year + " MLB champions!" + Environment.NewLine + results;
                NLPlayoffs[0].Awards.Add(new Award(World.calendar.Year, "World Series Champions"));
            }

            else
            {
                results = "The " + ALPlayoffs[0].City + " " + ALPlayoffs[0].Mascot + " are the " + World.calendar.Year + " MLB champions!" + Environment.NewLine + results;
                ALPlayoffs[0].Awards.Add(new Award(World.calendar.Year, "World Series Champions"));
            }
        ...
        private string DisplayMVPTop5()
        {
            ...
            alMVPRanks[0].Awards.Add(new Award(World.calendar.Year, "AL MVP"));
            nlMVPRanks[0].Awards.Add(new Award(World.calendar.Year, "NL MVP"));
        ...
        private string DisplayCyYoungTop5()
        {
            ...
            //give the winner the award
            alCYRanks[0].Awards.Add(new Award(World.calendar.Year, "AL Cy Young"));
            nlCYRanks[0].Awards.Add(new Award(World.calendar.Year, "NL Cy Young"));

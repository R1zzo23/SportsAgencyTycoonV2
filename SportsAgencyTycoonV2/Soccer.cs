...
namespace SportsAgencyTycoonV2
{
    public class Soccer
    {
        ...
        public void SimWeek()
        {
            if (World.calendar.Month == 10 && World.calendar.Week == 3)
            {
            ...
            if (MLS.WeekNumber == 34)
            {
                ...
                DisplayMidfielderOfTheYearTop5();
                DisplayDefensemanOfTheYearTop5();
                DisplayKeeperOfTheYearTop5();
                DeterminePlayoffField();
            }
            if (MLS.Playoffs)
            {
                if (MLS.WeekNumber == 35) SimulateFirstRound();  //mainForm.newsLabel.Text = SimulateFirstRound() + Environment.NewLine + mainForm.newsLabel.Text;
                else if (MLS.WeekNumber == 36 || MLS.WeekNumber == 37) SimulateSecondAndThirdRounds();  //mainForm.newsLabel.Text = SimulateSecondAndThirdRounds() + Environment.NewLine + mainForm.newsLabel.Text;
                else if (MLS.WeekNumber == 38) SimulateChampionship();  //mainForm.newsLabel.Text = SimulateChampionship() + Environment.NewLine + mainForm.newsLabel.Text;
            }
        }
        #region Statistics
        ...
        private string SimulateChampionship()
        {
            ...
            if (losingIndex == 0)
            {
                results = "The " + WesternPlayoffs[0].City + " " + WesternPlayoffs[0].Mascot + " are the " + World.calendar.Year + " MLS champions!" + Environment.NewLine + results;
                WesternPlayoffs[0].Awards.Add(new Award(World.calendar.Year, "MLS Champions"));
            }

            else
            {
                results = "The " + EasternPlayoffs[0].City + " " + EasternPlayoffs[0].Mascot + " are the " + World.calendar.Year + " MLS champions!" + Environment.NewLine + results;
                EasternPlayoffs[0].Awards.Add(new Award(World.calendar.Year, "MLS Champions"));
            }
        ...
        private string DisplayMidfielderOfTheYearTop5()
        {
            ...
            //give the winner the award
            midfielderRanks[0].Awards.Add(new Award(World.calendar.Year, "Midfielder of the Year"));
        ...
        private string DisplayDefensemanOfTheYearTop5()
        {
            ...
            //give the winner the award
            defenderRanks[0].Awards.Add(new Award(World.calendar.Year, "Defender of the Year"));
        ...
        private string DisplayKeeperOfTheYearTop5()
        {
            ...
            //give the winner the award
            keeperRanks[0].Awards.Add(new Award(World.calendar.Year, "Keeper of the Year"));
